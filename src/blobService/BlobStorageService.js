...
const getContainers = (request) => {
  const blobServiceClient = buildClient(request);
  return asyncToObservable(blobServiceClient.listContainers());
}
...
const asyncToObservable = (iterable) => {
